...
|----|-------|----------|-------------|--------|
| SIG-001 | State-changing function requires no authorization | critical | `no_require_auth` | todo |
...
| SIG-011 | Read-only function demands authorization | low | `over_auth_view` | todo |
